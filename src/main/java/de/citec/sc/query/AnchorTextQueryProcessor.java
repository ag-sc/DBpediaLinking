...
public class AnchorTextQueryProcessor implements QueryProcessor {

    private String entityIndexDirectory = "/anchorsindex/";
    private StandardAnalyzer analyzer;
    private Directory entityIndex;

    public AnchorTextQueryProcessor(String indexDirectory) {
        initIndexDirectory(indexDirectory);
    }

    public AnchorTextQueryProcessor() {
        initIndexDirectory("anchorIndex");
    }
    ...
    public List<String> getMatches(String label) {
        ...
        List<Instance> topK = getTopMatches(label, 1000);
    ...
    public void initIndexDirectory(String indexDirectory) {
        try {
            entityIndexDirectory = indexDirectory + "/anchorsindex/";
